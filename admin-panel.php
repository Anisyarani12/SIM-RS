  ...
  if(date("Y-m-d",$appdate1)>=$cur_date){
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
      $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
        ...
        echo "<script>alert('Maaf, Dokter tidak tersedia pada waktu ini. Silakan pilih waktu atau tanggal yang berbeda!');</script>";
      }
    }
    else{
      echo "<script>alert('Silakan pilih waktu atau tanggal lain!');</script>";
    }
  }
  else{
      echo "<script>alert('Silakan pilih waktu atau tanggal lain!');</script>";
...
if(isset($_GET['cancel']))
  {
    ...
    if($query)
    {
      echo "<script>alert('Konsultasi Anda Berhasil Dibatalkan');</script>";
    }
  }
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Daftar Kontrol</a>
      <a class="list-group-item list-group-item-action" href="#app-hist" id="list-pat-list" role="tab" data-toggle="list" aria-controls="home">Riwayat Kontrol</a>
    ...
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
               ...
               <div class="col-sm-4" style="left: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> DAFTAR KONTROL</h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">RIWAYAT KONTROL</h2>
                    
                      <p class="cl-effect-1">
                        <a href="#app-hist" onclick="clickDiv('#list-pat-list')">
                          Lihat Riwayat Kontrol
                        </a>
                      </p>
                    </div>
                  </div>
      ...
      <div class="tab-pane fade" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <center><h4>Daftar Kontrol</h4></center><br>
              ...
              document.getElementById('spec').onchange = function updateSpecs(e) {
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  <div class="col-md-4"><label>Tanggal Konsultasi</label></div>
                  <div class="col-md-8"><input type="date" class="form-control datepicker" name="appdate"></div><br><br>

                  <div class="col-md-4"><label>Waktu Konsultasi :</label></div>
                  <div class="col-md-8">
                  ...
                  <div class="col-md-4">
                    <input type="submit" name="app-submit" value="Daftar" class="btn btn-primary" id="inputbtn">
                  </div>
