...
if(isset($_POST['docsub']))
{
  ...
  if($result)
    {
      echo "<script>alert('Berhasil Menambahkan Dokter');</script>";
  }
}
...
if(isset($_POST['docsub1']))
{
  ...
  if($result)
    {
      echo "<script>alert('Berhasil Menghapus Data Dokter');</script>";
  }
  else{
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> RUMAH SAKIT UNIMUS</a>
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;"> Administrator </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list"  role="tab" data-toggle="list" aria-controls="home">Riwayat Konsultasi</a>
      <a class="list-group-item list-group-item-action" href="#list-settings" id="list-adoc-list"  role="tab" data-toggle="list" aria-controls="home">Tambahkan Dokter</a>
      ...
      <a class="list-group-item list-group-item-action" href="#list-mes" id="list-mes-list"  role="tab" data-toggle="list" aria-controls="home">Kontak Masuk</a>
                ...
                <div class="col-sm-4" style="left: 13%;margin-top: 5%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">RIWAYAT KONSULTASI</h4>
                ...
                <div class="col-sm-4" style="left: 18%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">TAMBAH DOKTER</h4>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    {
                      echo "Dibatalkan Pasien";
                    }

                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                      echo "Dibatalkan Dokter";
                    }
                        ?></td>
                      </tr>
                    <?php $cnt++; } ?>
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          ...
          <div class="col-md-4"><label>Nama Dokter:</label></div>
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      <option value="head" name="spec" disabled selected>Pilih Spesialis</option>
          ...
          <input type="submit" name="docsub" value="Tambah" class="btn btn-primary">
        </form>
      </div>
      ...
      <div class="tab-pane fade" id="list-settings1" role="tabpanel" aria-labelledby="list-settings1-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          ...
          <input type="submit" name="docsub1" value="Hapus" class="btn btn-primary" onclick="confirm('Apakan Anda Yakin Ingin Hapus?')">
        </form>
      </div>
