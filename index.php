...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('https://i.ibb.co.com/tcqvnTY/rsy.jpg');
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;">
                <h4><i class="fa fa-hospital-o" aria-hidden="true"></i>&nbsp RUMAH SAKIT UNIMUS</h4>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item" style="margin-left: 20px;">
                        <a class="nav-link js-scroll-trigger" href="jadwal.html" style="color: white;font-family: 'IBM Plex Sans', sans-serif;">
    ...
    <div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
        <div class="row">
            <div class="col-md-3 register-left" style="margin-top: 22%;right: 5%">
            ...
            <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <h3 class="register-heading">Registrasi Pasien</h3>
                            ...
                            <div class="row register-form">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="index1.php">Sudah Punya Akun? Masuk Disini</a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <h3 class="register-heading">Login Dokter</h3>
                    ...
                    <div class="tab-pane fade show" id="admin" role="tabpanel" aria-labelledby="profile-tab">
                        <h3 class="register-heading">Login Admin</h3>
